...
impl Default for Colors {
    fn default() -> Self {
        Colors {
            ...
            seekbar_filled: "#FFFFFF".to_string(),
            seekbar_unfilled: "#000000".to_string(),
            status: "#598EFF".to_string(),
            tab_selected: "#FF0000".to_string(),
            tab_unselected: "#FFFFFF".to_string(),
            timestamp: "#598EFF".to_string(),
